...
function! s:ActiveStatusLine()
    ...
    let s:statusline.="\ "
    let s:statusline.="%#HomeMode#%{spaceline#vimode#vim_mode()}"
    ...
    if !empty(spaceline#diagnostic#diagnostic_error())|| !empty(spaceline#diagnostic#diagnostic_warn()) && squeeze_width >10
        ...
        let s:statusline.="\ "
    elseif !empty(spaceline#file#file_size()) && squeeze_width > 10
